class DemoVR extends Demo {
    constructor() {
      ...
      // Si una pantalla está conectada o desconectada, entonces debemos verificar que
      // todavía están usando una pantalla válida
    ...
    // Elige la primera pantalla VR disponible
    _getDisplay() {
    ...
    _deactivateVR() {
      ...
      _presentChanged() {
        ...
        _onResize() {
          ...
          _render() {
            // Si no estamos presentando a una pantalla, entonces hagamos el renderizado no VR
            if (!this._display || !this._display.isPresenting) {
